...
function maxOfTwoNumbers( NumberX , NumberY ) {
  if( NumberX < NumberY ){
      return "El numero mas grande es: " + NumberY;
  } else if ( NumberY < NumberX ){
      return "El numero mas grande es: " + NumberX;
  } else
...
function averageNumbers(numbersArray) {
  ...
  return sumTotal/numbersArray.length;
}
...
function averageWordLength(wordsArray) {
  ...
  for(let i = 0; i < wordsArray.length; i++){
    sumTotal += wordsArray[i].length;
  }
  return sumTotal/wordsArray.length;
}
